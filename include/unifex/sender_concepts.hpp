...
inline const struct _fn {
  ...
  template(typename Operation)  //
      (requires                 //
       (!tag_invocable<_fn, Operation&>)) auto
...
public:
  template(typename Sender, typename Receiver)  //
      (requires                                 //
       ...
       (_with_tag_invoke<Sender, Receiver>)) auto
  ...
  template(typename Sender, typename Receiver)    //
      (requires                                   //
       ...
       (_with_member_connect<Sender, Receiver>)) auto
      operator()(Sender&& s, Receiver&& r) const  //
