...
public:
  ...
  manual_lifetime(std::in_place_t, Args&&... args)  //
  ...
  [[maybe_unused]] T& construct_with(Func&& func)  //
...
public:
  ...
  template <typename... Args>
  manual_lifetime(std::in_place_t, Args&&... args) noexcept {
    construct((Args &&) args...);
  }
...
public:
  ...
  manual_lifetime(std::in_place_t) noexcept {}
